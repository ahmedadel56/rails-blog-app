...
RSpec.describe 'User posts', type: :feature do
  scenario 'user posts page', js: true do
    ...
    @comment_1_post_one = Comment.create(post_id: @post_one.id, user_id: @user_two.id, text: 'Hi Ahmed this is Ahmed 2')
    @comment_2_post_one = Comment.create(post_id: @post_one.id, user_id: @user_three.id,
                                         text: 'Hi Ahmed this is Ahmed 3')
    @comment_1_post_two = Comment.create(post_id: @post_two.id, user_id: @user_two.id, text: 'Hi Ahmed this is Ahmed 2')
